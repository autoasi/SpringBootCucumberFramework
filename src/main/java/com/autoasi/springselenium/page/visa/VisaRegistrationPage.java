package com.autoasi.springselenium.page.visa;
...
public class VisaRegistrationPage extends Base {
    ...
    public void setNames(String firstName, String lastName){
        logger.info("Entering name - " + firstName + " " + lastName);
        this.firstName.sendKeys(firstName);
        this.lastName.sendKeys(lastName);
    }

    public void setFromCountryAndToCountry(String countryFrom, String countryTo){
    ...
    public void setComments(String comments){
        this.comments.sendKeys(Objects.toString(comments, "")); // if comments is null enter empty string
    }
